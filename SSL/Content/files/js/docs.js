...
*//*	var img = $('<img />');
	...
	*//*});
	var bookUrl = $("a[data-book-url]").attr("data-book-url");*//* // Get the book URL from data attribute
	*//*img.attr('src', 'files/pages/' +  (page-2) + '.jpg');*//*
*//*	img.attr('src', bookUrl + (page - 2) + '.jpg');*//*
	...
	*//*img.attr('src', 'pages/' + (page - 2) + '.png');*//*
	img.attr('src', bookUrl + (page - 2) + '.png');
	window.open("~/Media/ReadOnline/index.html");
}
*/



/*function loadPage(comicUrl, page) {
	var img = $('<img />');
	img.load(function () {
		var container = $('.sample-docs .p' + page);
		img.css({ width: container.width(), height: container.height() });
	...
	// Replace 'pages' with the provided comicUrl.
	img.attr('src', comicUrl + '/' + (page - 2) + '.jpg');
}
*/
